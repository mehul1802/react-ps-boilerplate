...
import bgpoolservice from '../../assets/images/pool-services-software-bg-1.jpg';
import servicesofticon from '../../assets/images/cleaning-stuff.png';
      ...
      <Grid fluid={true}>
        <Row className="service-packages">
          ...
          <Col md={4} sm={4} xs={12}>  <div className="col">
            <div className="box">
              ...
              <div className="desc">
                <p>Starting at </p>
                <b>${data.packages.premium.price}/mo</b>
              </div>
        ...
        <Row className="service-features">
          ...
          <Col md={6} sm={6} xs={12} className="col-right" >
            ...
            <div className="rate"><span className="dollor">{data.referral.price}$</span><br /><span>/mo</span></div>
      ...
      <Grid >
        <Row>
          <Col md={11} sm={11} >
            ...
            <Image src={bgpoolservice} className="img-pool-service" responsive={true} />
