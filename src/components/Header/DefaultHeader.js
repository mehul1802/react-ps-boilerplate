...
export default ({ isAuthenticated, handleLogout, data }) =>
  <header>
    <section className="header-section hidden-xs">
      <div className="container-fluid">
        <Col md={4} mdPush={8} className="header-topright"><a href={`tel:${data.contact.text}`}>+{data.contact.text}</a></Col>
      </div>
      ...
      <div className="header-title text-center"> Pool Services </div>
    </section>
    {/* // Header Section for mobile view */}
    <section className="header-section hidden-md hidden-sm hidden-lg">
